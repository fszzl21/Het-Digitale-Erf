import { Search, Filter, Calendar, ChevronDown, Loader2 } from 'lucide-react';
...
export function ReservationsTable({ limit }: ReservationsTableProps) {
  ...
  const statusColors: Record<string, string> = {
    ...
    'Ingecheckt': 'bg-green-100 text-green-700',
    'checked_in': 'bg-green-100 text-green-700',
    'Geannuleerd': 'bg-red-100 text-red-700',
    'cancelled': 'bg-red-100 text-red-700',
    'Uitgecheckt': 'bg-gray-100 text-gray-700',
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 flex justify-center items-center">
        ...
        <span className="ml-3 text-gray-600">Reserveringen laden...</span>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-gray-900">Recente Reserveringen</h2>
          {limit && (
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent"
            />
          </div>
