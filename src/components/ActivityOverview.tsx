  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-gray-900">Geplande Activiteiten</h2>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {activities.map((activity) => {
          ...
          return (
            <div key={activity.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 text-sm text-green-700 border border-green-700 rounded-lg hover:bg-green-50 transition-colors"
                  >
                    Details
                  </button>
                  <button
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="font-medium">{selectedActivity.current_participants}/{selectedActivity.max_participants}</span>
                </div>
              </div>
